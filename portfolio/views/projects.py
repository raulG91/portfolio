...
def projects()->rx.Component:
    ...
    return rx.vstack(
        ...
        rx.vstack(
            ...
            project_box("Bankig app","App for bank transactions, created during a hackaton organizated by Caixabank","/caixa_logo.png",['/python.svg','/mysql.svg','/docker.svg'],"https://github.com/raulG91/caixabank-backend-py-bankingapp.git","https://nuwe.io/es/hackathons/caixabank-tech-challenges-round-1?challenge=caixabank-tech-round-1-python")
